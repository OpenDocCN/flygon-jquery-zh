...
![Fully Responsive Photography](graphics/0069_07_03.jpg)
...
![Creating a basic gallery using PhotoSwipe](graphics/0069_07_09.jpg)
...
![Smartphone-sized devices](graphics/0069_07_10.jpg)
...
![Tablet-sized devices](graphics/0069_07_07.jpg)

## 桌面大小的设备

这仍然是一个 jQuery 移动页面，但我们看起来更像一个桌面站点。现在我们可以展示不止一张脸，因此我们不妨切换一些不同的照片来展示艺术家的能力：

![Desktop-sized devices](graphics/0069_07_08.jpg)
