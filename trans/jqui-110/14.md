...
![Using color animations](graphics/2209OS_14_01.jpg)
...
![Highlighting specified elements](graphics/2209OS_14_02.jpg)
...
![Transferring an element's outline](graphics/2209OS_14_03.jpg)
...
![Scaling elements on a page](graphics/2209OS_14_04.jpg)
...
![Exploding elements on a page](graphics/2209OS_14_05.jpg)
...
![Creating a puff effect](graphics/2209OS_14_06.jpg)
...
将此文件另存为`effectDrop.html`。单击按钮时，我们首先存储对按钮的 DOM 节点的引用。然后，我们为`position`实用程序添加一个配置对象，以便将工具提示定位到按钮的右侧。
...
![Adding the drop effect to elements](graphics/2209OS_14_07.jpg)
...
![Implementing the sliding effect](graphics/2209OS_14_08.jpg)
...
![Clipping elements](graphics/2209OS_14_09.jpg)
...
![Folding elements](graphics/2209OS_14_10.jpg)
