...
![Example 1 – minimum of three visible images (default)](graphics/3602OS_06_01.jpg)
...
![Example 2 – vertical with a minimum of three visible images](graphics/3602OS_06_02.jpg)
...
![Example 3 – fixed wrapper with a minimum of two visible images](graphics/3602OS_06_03.jpg)
...
![Example 4 – minimum of four images visible in an image gallery](graphics/3602OS_06_04.jpg)
...
![Example 1 – basic slider (default)](graphics/3602OS_06_05.jpg)
...
![Example 2 – slider with carousel slider as navigation control](graphics/3602OS_06_06.jpg)
...
![Example 3 – carousel setting minimum and maximum range](graphics/3602OS_06_07.jpg)
...
![Example 1](graphics/3602OS_06_08.jpg)
...
![Example 2](graphics/3602OS_06_09.jpg)
...
![Example 3](graphics/3602OS_06_10.jpg)
...
![How to do it](graphics/3602OS_06_11.jpg)
...
![Using the 3D flow style on Swiper](graphics/3602OS_06_12.jpg)
...
![How to do it](graphics/3602OS_06_13.jpg)
...
*   **Placement of controls**: Controls need to be positioned in a way that aligns with how people hold and use touch-enabled devices. The bottom area of a smartphone screen is where we want to put an application's most common and important interactions so that they may be reached quickly and easily, as shown in the following website example:
    ...
    ![Introducing touch gestures to user experience](graphics/3602OS_06_14.jpg)

类似地，我们可以观察平板电脑的姿势，或者人们通常如何手持平板电脑。人们用双手握住它们，或者只是在膝盖上的屏幕上打字：

![Introducing touch gestures to user experience](graphics/3602OS_06_15.jpg)
...
![Exercise 6 – creating an image slider using the Swiper plugin](graphics/3602OS_06_16.jpg)
