...
**提示:**如果您发现 Android 模拟器启动时间太长，您可能更愿意部署到实际设备上进行测试。对于这个设置，确保 USB 调试在你的设备上启用(设置![images](images/U001.jpg)应用![images](images/U001.jpg)开发)并将其插入你的系统。现在，当您运行您的应用程序时，它会启动得更快。
