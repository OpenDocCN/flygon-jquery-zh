...
![Putting Things into Perspective](graphics/5060OT_05_15.jpg)
...
![Sorting the occlusion](graphics/5060OT_05_03.jpg)

在第一种情况下，一个元素被另一个元素隐藏的唯一情况是它是否在它的正上方。很容易产生这种效果；我们可以简单地为每个高度使用一个组，并将精灵和平铺贴图放置在正确的组中。

例如，让我们考虑一个包含树和桥的层次，玩家可以在其中行走，就像下图所示：

![Sorting the occlusion](graphics/5060OT_05_04.jpg)

我们可以这样组织我们的游戏屏幕：

![Sorting the occlusion](graphics/5060OT_05_05.jpg)
...
![Sorting the occlusion](graphics/5060OT_05_06.jpg)
...
![Level versus sprite occlusion](graphics/5060OT_05_07.jpg)
...
![Collision detection](graphics/5060OT_05_08.jpg)
...
![Player versus environment collisions](graphics/5060OT_05_09.jpg)
...
![Using a tile map editor](graphics/5060OT_05_10.jpg)
...
![Using a tile map editor](graphics/5060OT_05_11.jpg)
...
![Player versus sprite collision](graphics/5060OT_05_12.jpg)
...
![Drawing an isometric tile map](graphics/5060OT_05_13.jpg)

为了实现这个神奇的效果，我们将使用两个法线平铺贴图来显示一个等距贴图。它们将重叠，但它们之间的偏移量等于一块瓷砖高度和宽度的一半。下图显示了它的外观：

![Drawing an isometric tile map](graphics/5060OT_05_14.jpg)
