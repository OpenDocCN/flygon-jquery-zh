...
我们选择将其编写为以下代码段，但真正取决于您以最有意义的方式创建 JSON 文件。如果您不熟悉 JSON文件应该遵循的确切语法，请快速阅读[http://www.json.org/](http://www.json.org/) 。
...
![Keeping the players in sync](graphics/5060OT_07_03.jpg)
