...
***[清单 31-1](#_list1)*** 。jQuery 移动页面中的简单表单
...
![image](images/sq.jpg) **提示**设置选项时，使用`slider`方法配置滑块控件，使用`rangeslider`方法配置范围滑块控件。
...
![9781430263883_Fig31-09.jpg](images/9781430263883_Fig31-09.jpg)
