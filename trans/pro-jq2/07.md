...
![image](images/sq.jpg) **提示**理解创建新元素并不会自动将它们添加到 DOM 中是很重要的。您需要明确地告诉 jQuery 新元素应该放在文档中的什么位置，我将在本章后面解释这一点。
...
![image](images/sq.jpg) **提示**您还可以提供一个 map 对象，指定应该应用于 HTML 元素的属性。你可以在[第 12 章](12.html)中看到这个版本的`$`函数。
...
![image](images/sq.jpg) **提示**您可以将值`true`作为参数传递给`clone`方法，以便在复制过程中包含事件处理程序和与元素相关的数据。省略此参数或指定值`false`会省略事件处理程序和数据。我将在第 9 章的[中解释 jQuery 对事件的支持，并在第 8 章](09.html)的[中解释如何将数据与元素相关联。](08.html)
...
![image](images/sq.jpg) **提示**您还可以使用`wrapInner`方法插入子元素，我在“包装元素内容”一节中对此进行了描述。此方法在元素及其现有子元素之间插入一个新的子元素。另一个技巧是使用`html`方法，我在第 8 章的[中描述过。](08.html)
...
![9781430263883_Fig07-01.jpg](images/9781430263883_Fig07-01.jpg)
...
![image](images/sq.jpg) **提示**`add`方法也接受包含 HTML 片段的字符串。您可以使用这个特性来替代使用`jQuery`对象构建新元素。
...
![9781430263883_Fig07-02.jpg](images/9781430263883_Fig07-02.jpg)
...
![image](images/sq.jpg) **提示**我使用`css`方法在单独的语句中设置 CSS `border`属性，但这只是为了让示例更容易理解。事实上，我可以像任何其他 jQuery 方法一样链接对`css`方法的调用。
...
![9781430263883_Fig07-03.jpg](images/9781430263883_Fig07-03.jpg)
...
![9781430263883_Fig07-04.jpg](images/9781430263883_Fig07-04.jpg)
...
![9781430263883_Fig07-05.jpg](images/9781430263883_Fig07-05.jpg)
...
![9781430263883_Fig07-06.jpg](images/9781430263883_Fig07-06.jpg)
...
![image](images/sq.jpg) **提示**包装方法的补充是`unwrap`，我将在本章后面的“移除元素”一节中描述它。
...
![9781430263883_Fig07-07.jpg](images/9781430263883_Fig07-07.jpg)
...
![9781430263883_Fig07-08.jpg](images/9781430263883_Fig07-08.jpg)
...
![9781430263883_Fig07-09.jpg](images/9781430263883_Fig07-09.jpg)
...
![9781430263883_Fig07-10.jpg](images/9781430263883_Fig07-10.jpg)
...
![9781430263883_Fig07-11.jpg](images/9781430263883_Fig07-11.jpg)
...
![9781430263883_Fig07-12.jpg](images/9781430263883_Fig07-12.jpg)
...
![9781430263883_Fig07-13.jpg](images/9781430263883_Fig07-13.jpg)
...
![9781430263883_Fig07-14.jpg](images/9781430263883_Fig07-14.jpg)
...
![9781430263883_Fig07-15.jpg](images/9781430263883_Fig07-15.jpg)

[图 7-15](#_Fig15) 。使用函数替换元素

![image](images/sq.jpg) **提示**如果你不想替换一个元素，那么你可以简单的返回一个克隆体。如果不克隆元素，jQuery 最终会完全删除元素。当然，您可以通过缩小选择范围来避免这个问题，但这并不总是一个选项。
...
![9781430263883_Fig07-16.jpg](images/9781430263883_Fig07-16.jpg)

[图 7-16](#_Fig16) 。从 DOM 中移除元素

![image](images/sq.jpg) **提示**从`remove`方法返回的`jQuery`对象包含原始的一组选定元素。换句话说，元素的移除不会反映在方法结果中。
...
![9781430263883_Fig07-17.jpg](images/9781430263883_Fig07-17.jpg)
...
![9781430263883_Fig07-18.jpg](images/9781430263883_Fig07-18.jpg)
...
![9781430263883_Fig07-19.jpg](images/9781430263883_Fig07-19.jpg)
