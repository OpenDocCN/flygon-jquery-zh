# 一、准备第一个 jQueryMobile项目

您知道 jQuery Mobile 是什么，它的历史以及它的特性和目标。现在，我们将实际构建我们的第一个 jQueryMobile网站（嗯，web 页面），看看它有多容易使用。
...
好的，我们已经有了比特，我们如何使用它们？向站点添加 jQueryMobile支持至少需要以下三个步骤：
