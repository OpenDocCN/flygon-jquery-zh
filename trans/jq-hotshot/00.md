...
[项目 4](04.html "Chapter 4. A jQuery Mobile Single-page App")*是一款 jQueryMobile单页应用程序*，为了构建一个将 jQuery 与 Stack Exchange API 相结合的移动应用程序，它将研究优秀的 jQueryMobile框架。我们还将介绍 jQuery 的官方模板引擎 JsRender。
